...
#include <memory>
#include "../../Client/source/GUI/MainForm.h"
...
QT_MOC_LITERAL(1, 9, 24), // "slotFillUdpPlainTextEdit"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 4), // "text"
QT_MOC_LITERAL(4, 40, 24) // "slotFillTcpPlainTextEdit"

    },
    "MainForm\0slotFillUdpPlainTextEdit\0\0"
    "text\0slotFillTcpPlainTextEdit"
};
...
void MainForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotFillUdpPlainTextEdit((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slotFillTcpPlainTextEdit((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
